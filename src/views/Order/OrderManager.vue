    ...
    <el-table-column label="商品" width="640" align="center">
      <template slot-scope="scope">
        <el-table :data="scope.row.goodsInfo" border style="width: 100%">
          ...
          <el-table-column label="名称" prop="goodsId.name" width="166" align="center"></el-table-column>
          ...
          <el-table-column label="单位" prop="goodsId.unit" width="112" align="center"></el-table-column>
        </el-table>
      </template>
    </el-table-column>
