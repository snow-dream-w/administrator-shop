<template>
  <el-table :data="tableData" border style="width: 938px">
    <el-table-column label="商品" width="640" align="center">
      <template slot-scope="scope">
        <el-table :data="scope.row.goods" border style="width: 100%">
          ...
          <el-table-column label="单价" prop="price" width="110" align="center"></el-table-column>
          <el-table-column label="数量" prop="num" width="110" align="center"></el-table-column>
          <el-table-column label="单位" prop="danwei" width="112" align="center"></el-table-column>
        </el-table>
      </template>
    </el-table-column>
    <el-table-column prop="money" label="实付款" width="120" align="center"></el-table-column>
